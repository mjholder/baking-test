"""
Django settings for baking-test project.
...
APP_NAME = os.getenv("APP_NAME", "baking-test")
...
MIDDLEWARE = [
    ...
    'baking-test.middleware.metricsmiddleware.MetricsMiddleware',
]

ROOT_URLCONF = 'baking-test.urls'
...
WSGI_APPLICATION = 'baking-test.wsgi.application'
